...
void insertarPosicion(ListaPtr lista, DatoPtr dato, int posc){

    if(posc < 0){

        printf("\nERROR! LA POSICION INGRESADA DEBE SER MAYOR O IGUAL A 0\n");

    }else{

        if(posc > obtenerTamanio(lista)){

            printf("\nERROR! LA POSICION INGRESADA EXCEDE EL TAMANIO DE LA LISTA\n");
            ...
            if(posc == 0){
                ...
                if(posc == obtenerTamanio(lista)+1){
